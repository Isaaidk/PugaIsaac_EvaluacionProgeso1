...
namespace PugaIsaac_EvaluacionProgeso1.Controllers
{
    public class CelularesController : Controller
    {
        ...
        public CelularesController(PugaIsaac_EvaluacionProgeso1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Año,Precio")] Celular celular)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Año,Precio")] Celular celular)
        {
            if (id != celular.Id)
            {
                return NotFound();
